...
{
    /// <summary>
    /// Implements <see cref="IPageObjectFactory"/> contract and delegates responsibility for creating
    /// actual page object and initializing it's members to subclasses. It class takes care of
    /// locating suitable for initialization members and assigning value to it. It looks for all
    /// instance fields and properties which are web elements or web element lists and have not been
    /// assigned value yet. Both fields and properties can be private protected or public, but in
    /// order to be initialized fields should not be marked <value>readonly</value> and properties
    /// should have setters.
    /// </summary>
    public abstract class AbstractPageObjectFactory : IPageObjectFactory
    {
        ...
        /// <returns>Custom WebElement found in given search context with provided locator</returns>
        ...
        /// <returns>Custom list of WebElements</returns>
        ...
        /// </returns>
        public abstract TPageObject CreateWebElement<TPageObject>(ISearchContext searchContext, By locator)
        ...
        protected abstract object CreateMemberInstance(Type memberType, MemberInfo memberInfo,
