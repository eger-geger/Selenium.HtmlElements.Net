...
namespace HtmlElements.Elements
{
    ...
    public class HtmlPage : WebDriverWrapper
    {
        ...
        /// <see cref="IWebDriver"/>, <see cref="IWebElement"/> or anything else which is wrapping
        /// WebDriver instance and can be used for locating elements
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// If the page has been modified after loading (for example, by JavaScript) there is no
        /// guarantee that the returned text is that of the modified page. Please consult the
        /// documentation of the particular driver being used to determine whether the returned text
        /// reflects the current state of the page or the text last sent by the web server. The page
